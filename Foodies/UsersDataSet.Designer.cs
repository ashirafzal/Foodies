...
namespace Foodies {
    ...
    public partial class UsersDataSet : global::System.Data.DataSet {
        ...
        public partial class usersDataTable : global::System.Data.TypedTableBase<usersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public usersRow AddusersRow(int Id, string username, string password, string category) {
...
namespace Foodies.UsersDataSetTableAdapters {
    ...
    public partial class usersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[users] WHERE (([Id] = @Original_Id) AND ((@IsNull_username = 1 AND [username] IS NULL) OR ([username] = @Original_username)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ((@IsNull_category = 1 AND [category] IS NULL) OR ([category] = @Original_category)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[users] ([Id], [username], [password], [category]) VALUES (@Id," +
                " @username, @password, @category);\r\nSELECT Id, username, password, category FROM" +
                " users WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[users] SET [Id] = @Id, [username] = @username, [password] = @password, [category] = @category WHERE (([Id] = @Original_Id) AND ((@IsNull_username = 1 AND [username] IS NULL) OR ([username] = @Original_username)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ((@IsNull_category = 1 AND [category] IS NULL) OR ([category] = @Original_category)));
SELECT Id, username, password, category FROM users WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, username, password, category FROM dbo.users";
        ...
        public virtual int Delete(int Original_Id, string Original_username, string Original_password, string Original_category) {
        ...
        public virtual int Insert(int Id, string username, string password, string category) {
        ...
        public virtual int Update(int Id, string username, string password, string category, int Original_Id, string Original_username, string Original_password, string Original_category) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string username, string password, string category, int Original_Id, string Original_username, string Original_password, string Original_category) {
            return this.Update(Original_Id, username, password, category, Original_Id, Original_username, Original_password, Original_category);
        }
    }
