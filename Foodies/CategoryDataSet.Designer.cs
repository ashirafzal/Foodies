...
namespace Foodies {
    ...
    public partial class CategoryDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public ProductsRow AddProductsRow(string ProductCategory, byte[] ProductImage) {
...
namespace Foodies.CategoryDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Products] WHERE (([ProductId] = @Original_ProductId) AND ((@Is" +
                "Null_ProductCategory = 1 AND [ProductCategory] IS NULL) OR ([ProductCategory] = " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([ProductCategory], [ProductImage]) VALUES (@Product" +
                "Category, @ProductImage);\r\nSELECT ProductId, ProductCategory, ProductImage FROM " +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [ProductCategory] = @ProductCategory, [ProductImage] = @ProductImage WHERE (([ProductId] = @Original_ProductId) AND ((@IsNull_ProductCategory = 1 AND [ProductCategory] IS NULL) OR ([ProductCategory] = @Original_ProductCategory)));
SELECT ProductId, ProductCategory, ProductImage FROM Products WHERE (ProductId = @ProductId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductId, ProductCategory, ProductImage FROM dbo.Products";
        ...
        public virtual int Fill(CategoryDataSet.ProductsDataTable dataTable) {
        ...
        public virtual CategoryDataSet.ProductsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CategoryDataSet.ProductsDataTable dataTable = new CategoryDataSet.ProductsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CategoryDataSet.ProductsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ProductId, string Original_ProductCategory) {
            ...
            if ((Original_ProductCategory == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[2].Value = ((string)(Original_ProductCategory));
            }
        ...
        public virtual int Insert(string ProductCategory, byte[] ProductImage) {
        ...
        public virtual int Update(string ProductCategory, byte[] ProductImage, int Original_ProductId, string Original_ProductCategory, int ProductId) {
            if ((ProductCategory == null)) {
            ...
            if ((Original_ProductCategory == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((string)(Original_ProductCategory));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ProductCategory, byte[] ProductImage, int Original_ProductId, string Original_ProductCategory) {
            return this.Update(ProductCategory, ProductImage, Original_ProductId, Original_ProductCategory, Original_ProductId);
        }
    }
