...
namespace Foodies
{
    public partial class SalesSummary : Form
    {
        ...
        /*** Method for checking tje total amount on panel and count from the datagridview 2 to match for checking purpose of total 
            Total success have been acheived as both total mathces each other
         ***/
        //public void abondenedcheckingcodeForTotalAmount()
        //{
        //    for (int i = 0; i <= 1; i++)
        //    {
        //        string query = "select * from Bill where ProductName = 'Large Tikka Pizza' ";
        //        SqlCommand cmd = new SqlCommand(query, con);
        //        DataTable dt = new DataTable();
        //        SqlDataAdapter da = new SqlDataAdapter(cmd);
        //        da.Fill(dt);
        ...
        //        {
        //            totalAmount += Convert.ToInt32(dgv2.Rows[i].Cells[7].Value);
        //            totalqty += Convert.ToInt32(dgv2.Rows[i].Cells[5].Value);
        //        }

        //        MessageBox.Show(totalqty.ToString() + "   " + totalAmount.ToString());
        //        dgv2.Refresh();
        //        dgv2.DataSource = null;
        //    }
        //}
